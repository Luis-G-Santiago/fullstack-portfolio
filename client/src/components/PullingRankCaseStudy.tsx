    ...
    <article className="space-y-20">
      ...
      <section>
        ...
        <p className="mt-6 max-w-3xl text-xl leading-8 text-slate-300">
          A full-stack military rank discussion and comparison forum built with
      ...
      <section>
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-300">
          Pulling Rank is a web application for exploring and comparing military
          rank information. The application combines a React frontend with a
      ...
      <section>
        ...
        <p className="mt-5 max-w-3xl text-slate-300">
          The frontend communicates with the Express API through REST endpoints,
          while Mongoose handles communication between the backend and MongoDB
          Atlas.
        </p>
        ...
        <div className="mt-6 flex flex-col items-center gap-3 text-center sm:flex-row">
          <div className="rounded-lg border border-slate-700 bg-slate-800 px-6 py-4">
            ...
            <p className="mt-1 text-sm text-blue-400">Frontend</p>
          </div>

          <span className="text-slate-500 sm:text-xl">→</span>

          <div className="rounded-lg border border-slate-700 bg-slate-800 px-6 py-4">
            <p className="font-semibold text-white">Node + Express</p>
            <p className="mt-1 text-sm text-blue-400">REST API</p>
          </div>

          <span className="text-slate-500 sm:text-xl">→</span>

          <div className="rounded-lg border border-slate-700 bg-slate-800 px-6 py-4">
            <p className="font-semibold text-white">MongoDB Atlas</p>
            <p className="mt-1 text-sm text-blue-400">Database</p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-300">
          JWT-based authentication protects authenticated functionality. After a
          successful login, the backend issues a token that the frontend uses
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3 text-sm font-medium text-slate-300">
          <span className="rounded-md bg-slate-800 px-4 py-2">Login</span>

          <span className="text-slate-500">→</span>

          <span className="rounded-md bg-slate-800 px-4 py-2">JWT</span>
      ...
      <section>
        ...
        <div className="mt-5 max-w-3xl">
          ...
          <p className="mt-3 leading-8 text-slate-300">
            ...
            connectivity issues when communicating with the Express backend. I
            traced requests between the Vite development server and API,
            adjusted the CORS configuration and development proxy setup, and
            verified the endpoints with curl and Postman.
          </p>
        </div>
      </section>
        ...
        <div className="mt-6 grid gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            ...
            <p className="mt-2 leading-7 text-slate-300">
              Built the React interface and connected it to the backend API for
          ...
          <div>
            ...
            <p className="mt-2 leading-7 text-slate-300">
              Built the Node.js and Express REST API and implemented the
          ...
          <div>
            ...
            <p className="mt-2 leading-7 text-slate-300">
              Integrated MongoDB Atlas with Mongoose for storing and accessing
              rank data.
            </p>
          </div>
